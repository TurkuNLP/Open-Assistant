          ...
          <Stack spacing="6" mb="6">
            ...
            <Box bg={backgroundColor} p="6" pt="4" borderRadius="xl" shadow="base">
              <Stack>
                ...
                Tästä tietosuojakäytännöstä saat tietää, mitä henkilötietoja käsittelemme, kun vierailet verkkosivustollamme, 
                ja mihin tarkoitukseen, sekä mitä oikeuksia sinulla on näihin tietoihin liittyen. Kategorisesti ottaen säilytämme 
                tietoja vain niin kauan kuin tarvitsemme niitä. Henkilötietojen toimittamiseen meille ei ole oikeudellista velvoitetta. 
                EU:n tietosuoja-asetuksen 22 artiklan mukaista automatisoitua päätöksentekoa ei tapahdu.
                </Text>
              </Stack>
            </Box>
          </Stack>
